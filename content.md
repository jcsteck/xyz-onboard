...
------
### Now let’s make some more stuff. <br><br>
<p class="fragment">
►
</p>
------
...
------
###Remember...
Anything deleted from the server will immediately be deleted. There is no trash on your machine. However, we have nightly backups of the server, so should you accidently delete something you need, it can be retrieved.<p style="display:inline" class="fragment" data-fragment-index="1"> Had you scared, huh? :) </p>
...
<img id="img-1" class="fragment" width="40%" data-src="media/img/img-1.png" data-fragment-index="1"></img>
<p class="fragment" data-fragment-index="2">
...
<img id="img-2" class="fragment" width="40%" data-src="media/img/img-1.png" data-fragment-index="3" >
<br>
...
<div class="name-fail">
<p style="display:inline" class="fragment" data-fragment-index="1">test</p>
<p style="display:inline" class="fragment" data-fragment-index="2">_04</p>
<p style="display:inline" class="fragment" data-fragment-index="3">_final</p>
<p style="display:inline" class="fragment" data-fragment-index="4">_final2</p>
<p style="display:inline" class="fragment" data-fragment-index="5">_final_v2</p>
</div><br>
<div class="name-fail2"><br>
<p style="display:inline" class="fragment" data-fragment-index="6"> Ehhh... Not really </p>
...
<img id="img-3" style="margin-top: 3%" class="fragment" width="50%" data-src="media/img/img-3.png" data-fragment-index="1" >
<p class="fragment" data-fragment-index="1">
▼
</p>
---
...
<img id="img-4" style="margin-top: 3%" class="fragment" width="50%" data-src="media/img/img-4.png" data-fragment-index="1" >
<p class="fragment" data-fragment-index="1">
<img id="img-5" style="margin-top: 3%" class="fragment" width="50%" data-src="media/img/img-5.png" data-fragment-index="1" >
<p class="fragment" data-fragment-index="1">
▼
</p>
---
...
<img id="img-6" style="margin-top: 3%" class="fragment" width="70%" data-src="media/img/img-6.png" data-fragment-index="1" >
...
<table style="float: left; width:35%; margin:3%; margin-top:4%">
  ...
  <img td align="left" src="media/img/LOGOal.png" style="vertical-align: middle; max-width: 40%; ; margin:10%">
  </td>
  ...
  <img src="media/img/brady_logo.png" style="vertical-align: middle; align-content:center; max-width: 40%; margin:5%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%"  width="20%">             
  BRAD
  </td>
  ...
  <img src="media/img/espn-logo.png" style="vertical-align: middle; max-width: 50%; margin:5%">
  </td>
  ...
  <img src="media/img/GoogleAds_logo.png" style="vertical-align: middle; max-width: 25%; margin:5%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  GOADS
  </td>
  ...
  <tr style="vertical-align:middle">
  <td td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/GoogleAssistant_logo.png" style="vertical-align: middle; max-width: 125%; margin:5%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  GASS
  </td>
  ...
  <tr style="vertical-align:middle">
  <td td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/Chromebook_logo.png" style="vertical-align: middle; max-width: 100%; margin:5%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  GCHR
  </td>
...
<table style="float:right; width:35%; margin:3%;  margin-top:5%">
  <tr style="vertical-align:middle">
  <td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/wellbeing-logo.png" style="vertical-align: middle; max-width: 200%; margin:5%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  GDIG
  </td>
  ...
  <tr style="vertical-align:middle">
  <td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/GPay_logo.png" style="vertical-align: middle; max-width: 200%; margin:5%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  GPAY
  </td>
  ...
  <tr style="vertical-align:middle">
  <td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/KITS_logo.png" style="vertical-align: middle; max-width: 200%; margin:10%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  KITS
  </td>
  ...
  <tr style="vertical-align:middle">
  <td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/NBCUniversal_logo.png" style="vertical-align: middle; max-width: 500%; margin:10%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  NBCU
  </td>
  ...
  <tr style="vertical-align:middle">
  <td align="left" class="table-element" style="vertical-align:middle" width="10%">
  <img src="media/img/NETFLIX_logo.png" style="vertical-align: middle; max-width: 300%; margin:10%">
  </td>
  <td align="center" style="vertical-align:middle; padding-bottom:4%">             
  NETF
  </td>
...
<img id="gif-2" class="fragment" width="30%" data-src="media/img/gif-2.gif">
...
If you need a sequence that is not part of the template project provided, let XYZ Producer know and they can set one up for you with the correct specs.<br><br>
▼
